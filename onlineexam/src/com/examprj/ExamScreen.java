...
public class ExamScreen extends JFrame{
    ...
    public ExamScreen() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(ExamScreen.class.getResource("/com/examprj/examlogo.png"))); // Change the icon
        ...
        questions.add(new Question("Who invented java programming?", "james Gosling", new String[]{"Guido van Rossum", "james Gosling", "Dennis Ritchie", "Bjarne Stroustrup"}));
        questions.add(new Question("Which component is used to compile,debug and execute the java programs?", "JDK", new String[]{"JRE", "JIT", "JDK", "JVM"}));
        questions.add(new Question("which of the following is not an OOPS concept in java?" , "compilation", new String[]{"Polymorphism", "inheritence", "compilation", "Encapsulation"}));
        questions.add(new Question("Which of the following is a type of polymorphism in java programming?", "Compile time polymorphism", new String[]{"Multiple polymorphism", "Compile time polymorphism", "Multilevel polymorphism", "Execution time polymorphism"}));
        questions.add(new Question("Which of the following is a superclass of every class in Java?", "Object class", new String[]{"Array List", "Abstract class", "Object class", "String"}));
